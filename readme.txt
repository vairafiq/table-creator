...
You can also create unlimited normal tables using this plugin if you do not want to use any advanced features like searching, filtering, pagination etc. 
...
Similarly, you can export your table data to a CSV file with this plugin so that you can save your data for future use or you can use it anywhere else. 
