<?php
// Protect direct script access.
defined( 'ABSPATH' ) || die( 'You can not access this page directly!' );

if( !class_exists( 'ATTC_export' ) ) :    
    class ATTC_export{
        ...
        public function export_table( array $table, $export_format, $csv_delimiter ) {
            switch ( $export_format ) {
                case 'csv':
                    ...
                    foreach ( $table['content'] as $row_idx => $row ) {
                        $csv_row = array();
                ...
                case 'html':
                    ...
                    foreach ( $table['content'] as $row_idx => $row ) {
                        ...
                        if ( 0 === $row_idx && $table['options']['t_head'] && $num_rows > 1 ) {
